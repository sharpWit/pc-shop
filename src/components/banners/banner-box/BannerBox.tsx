...
const BannerBox: React.FC<Props> = ({
  ...
  return (
    <div className="col-span-6 flex items-center justify-center shadow-2xl relative rounded-lg overflow-hidden dark:bg-gray-500/70 !dark:bg-blend-multiply">
      ...
      <div className="flex justify-between items-center gap-2 sm:block absolute top-[25%] sm:top-3 md:top-8 lg:top-2 2xl:top-6 sm:left-[35%] sm:w-[55%] md:w-1/2 lg:w-[60%] xl:w-1/2 bg-card/30 p-2 rounded-md">
        <h3 className="text-popover dark:text-white text-lg lg:text-xl xl:text-2xl font-titles font-semibold lg:font-bold sm:pt-4 lg:pt-2 xl:pt-4">
          {title}
        </h3>
